...
public class OthersCategory extends AppCompatActivity {
...
//        });
    ...
    private void EventChangeListener() {
        fStore.collection("othersList").orderBy("name", Query.Direction.ASCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
